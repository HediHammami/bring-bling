...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/opt/lampp/htdocs/prestashop/modules/psxdesign/src/Entity']);
        $e->addExcludePaths([0 => '/opt/lampp/htdocs/prestashop/modules/psxdesign/src/Entity/index.php']);
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/opt/lampp/htdocs/prestashop/modules/ps_accounts/src/Entity']);
        $f->addExcludePaths([0 => '/opt/lampp/htdocs/prestashop/modules/ps_accounts/src/Entity/index.php']);
        $g = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/opt/lampp/htdocs/prestashop/modules/ps_checkout/src/Entity']);
        $g->addExcludePaths([0 => '/opt/lampp/htdocs/prestashop/modules/ps_checkout/src/Entity/index.php']);
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('8.1.4', '/opt/lampp/htdocs/prestashop', false);
    }
