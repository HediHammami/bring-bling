...
<div class="easycarousels horizontal-tabs clearfix{if $is_16} ps-16{/if}">
...
<div class="easycarousels">{$ec->renderPossibleWarnings()}{* can not be escaped *}</div>
<div class="easycarousels horizontal-tabs-content">
	<div id="carousels" class="tab-panel panel active all-carousels clearfix">
	...
	<div id="overrides" class="tab-panel panel clearfix">
	...
	<div id="info" class="tab-panel panel clearfix">
		<div class="info-row">
