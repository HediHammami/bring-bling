...
$(document).ready(function() {
	...
	function toggleBestsellersOpton() {
		let show = $('#carousel_type').val() == 'bestsellers' || $('.select_order_by:visible').val() == 'sales';
		$('.bestsellers-option').toggleClass('hidden', !show);
	}
...
var ecb = {
	...
	horizontalTabs: function() {
		let $t = $('.easycarousels.horizontal-tabs').on('click', '.nav-tab-name', function(e) {
			e.preventDefault();
