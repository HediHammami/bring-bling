...
class MensProducts extends Module
{
    public function __construct()
    {
        $this->name = 'mensproducts';
        ...
        $this->displayName = $this->l('Product Slider for men');
    ...
    public function hookDisplayHome($params)
    {
        ...
        $this->context->controller->addCSS($this->_path . 'views/css/slider-men.css');
        $this->context->controller->addJS($this->_path . 'views/js/owl.carousel.min.js');
        $this->context->controller->addJS($this->_path . 'views/js/slider-men.js');
        ...
        return $this->display(__FILE__, 'views/templates/hook/slider-men.tpl');
    }
}
